...
# instance fields
.field public final d:Lg/p/b/a/q0/g$b;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lg/p/b/a/q0/a$d;

    invoke-direct {v0}, Lg/p/b/a/q0/a$d;-><init>()V

    .line 1
    invoke-direct {p0}, Lg/p/b/a/q0/d;-><init>()V

    iput-object v0, p0, Landroidx/media2/exoplayer/external/trackselection/DefaultTrackSelector;->d:Lg/p/b/a/q0/g$b;
...
.method public static a(Landroidx/media2/exoplayer/external/source/TrackGroup;IIZ)Ljava/util/List;
    ...
    :goto_0
    iget v3, p0, Landroidx/media2/exoplayer/external/source/TrackGroup;->e:I
    ...
    :goto_1
    iget v5, p0, Landroidx/media2/exoplayer/external/source/TrackGroup;->e:I
    ...
    .line 5
    iget-object v5, p0, Landroidx/media2/exoplayer/external/source/TrackGroup;->f:[Landroidx/media2/exoplayer/external/Format;

    aget-object v5, v5, v3

    .line 6
    iget v7, v5, Landroidx/media2/exoplayer/external/Format;->r:I

    if-lez v7, :cond_6

    iget v8, v5, Landroidx/media2/exoplayer/external/Format;->s:I
    ...
    invoke-static {v11, v7}, Lg/p/b/a/s0/a0;->a(II)I
    ...
    invoke-static {v10, v8}, Lg/p/b/a/s0/a0;->a(II)I
    ...
    iget v5, v5, Landroidx/media2/exoplayer/external/Format;->s:I
    ...
    .line 9
    iget-object p3, p0, Landroidx/media2/exoplayer/external/source/TrackGroup;->f:[Landroidx/media2/exoplayer/external/Format;

    aget-object p2, p3, p2

    .line 10
    invoke-virtual {p2}, Landroidx/media2/exoplayer/external/Format;->e()I
...
.method public static a(Landroidx/media2/exoplayer/external/Format;ILandroidx/media2/exoplayer/external/trackselection/DefaultTrackSelector$a;ZZ)Z
    .locals 3
    ...
    iget p1, p0, Landroidx/media2/exoplayer/external/Format;->z:I

    const/4 v1, -0x1

    if-eq p1, v1, :cond_2

    iget v2, p2, Landroidx/media2/exoplayer/external/trackselection/DefaultTrackSelector$a;->a:I

    if-ne p1, v2, :cond_2

    if-nez p3, :cond_0

    iget-object p1, p0, Landroidx/media2/exoplayer/external/Format;->m:Ljava/lang/String;
    ...
    iget p0, p0, Landroidx/media2/exoplayer/external/Format;->A:I
...
.method public static a(Landroidx/media2/exoplayer/external/Format;Ljava/lang/String;IIIIII)Z
    ...
    iget-object p2, p0, Landroidx/media2/exoplayer/external/Format;->m:Ljava/lang/String;

    invoke-static {p2, p1}, Lg/p/b/a/s0/a0;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_0
    iget p1, p0, Landroidx/media2/exoplayer/external/Format;->r:I
    ...
    :cond_1
    iget p1, p0, Landroidx/media2/exoplayer/external/Format;->s:I
    ...
    :cond_2
    iget p1, p0, Landroidx/media2/exoplayer/external/Format;->t:F
    ...
    :cond_3
    iget p0, p0, Landroidx/media2/exoplayer/external/Format;->i:I
...
# virtual methods
.method public a()Landroidx/media2/exoplayer/external/trackselection/DefaultTrackSelector$c;
    .locals 2
...
.method public a(Landroidx/media2/exoplayer/external/trackselection/DefaultTrackSelector$Parameters;)V
    ...
    .line 11
    iget-object p1, p0, Lg/p/b/a/q0/i;->a:Lg/p/b/a/q0/i$a;

    if-eqz p1, :cond_0

    check-cast p1, Lg/p/b/a/q;

    .line 12
    iget-object p1, p1, Lg/p/b/a/q;->k:Lg/p/b/a/s0/w;

    const/16 v0, 0xb

    invoke-virtual {p1, v0}, Lg/p/b/a/s0/w;->a(I)Z
...
.method public a(Landroidx/media2/exoplayer/external/trackselection/DefaultTrackSelector$c;)V
    .locals 0

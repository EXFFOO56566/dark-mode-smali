...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Lg/b/a;->listMenuViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Lg/b/j;->MenuView:[I

    const/4 v2, 0x0

    invoke-static {v0, p2, v1, p3, v2}, Lg/b/q/v0;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lg/b/q/v0;

    move-result-object p2

    sget p3, Lg/b/j;->MenuView_android_itemBackground:I

    invoke-virtual {p2, p3}, Lg/b/q/v0;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object p3

    iput-object p3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->n:Landroid/graphics/drawable/Drawable;

    sget p3, Lg/b/j;->MenuView_android_itemTextAppearance:I

    const/4 v0, -0x1

    invoke-virtual {p2, p3, v0}, Lg/b/q/v0;->f(II)I

    move-result p3

    iput p3, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->o:I

    sget p3, Lg/b/j;->MenuView_preserveIconSpacing:I

    invoke-virtual {p2, p3, v2}, Lg/b/q/v0;->a(IZ)Z
    ...
    sget p3, Lg/b/j;->MenuView_subMenuArrow:I
    ...
    .line 1
    iget-object p2, p2, Lg/b/q/v0;->b:Landroid/content/res/TypedArray;
...
.method public final a()V
    ...
    sget v1, Lg/b/g;->abc_list_menu_item_checkbox:I
...
.method public a(Lg/b/p/i/i;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->e:Lg/b/p/i/i;
    ...
    .line 1
    invoke-interface {p0}, Lg/b/p/i/n$a;->b()Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-virtual {p1}, Lg/b/p/i/i;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1}, Lg/b/p/i/i;->f()Z

    move-result p2

    invoke-virtual {p1}, Lg/b/p/i/i;->b()C

    if-eqz p2, :cond_2

    .line 4
    iget-object p2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->e:Lg/b/p/i/i;

    invoke-virtual {p2}, Lg/b/p/i/i;->f()Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->e:Lg/b/p/i/i;

    .line 5
    invoke-virtual {v2}, Lg/b/p/i/i;->b()C
    ...
    :cond_3
    iget-object v4, v2, Lg/b/p/i/i;->n:Lg/b/p/i/g;

    .line 6
    iget-object v4, v4, Lg/b/p/i/g;->a:Landroid/content/Context;
    ...
    iget-object v6, v2, Lg/b/p/i/i;->n:Lg/b/p/i/g;

    .line 8
    iget-object v6, v6, Lg/b/p/i/g;->a:Landroid/content/Context;
    ...
    sget v6, Lg/b/h;->abc_prepend_shortcut_label:I
    ...
    invoke-virtual {v6}, Lg/b/p/i/g;->f()Z

    move-result v6

    if-eqz v6, :cond_5

    iget v2, v2, Lg/b/p/i/i;->k:I

    goto :goto_3

    :cond_5
    iget v2, v2, Lg/b/p/i/i;->i:I

    :goto_3
    const/high16 v6, 0x10000

    sget v7, Lg/b/h;->abc_menu_meta_shortcut_label:I

    invoke-virtual {v4, v7}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v7

    invoke-static {v5, v2, v6, v7}, Lg/b/p/i/i;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const/16 v6, 0x1000

    sget v7, Lg/b/h;->abc_menu_ctrl_shortcut_label:I
    ...
    sget v7, Lg/b/h;->abc_menu_alt_shortcut_label:I
    ...
    sget v7, Lg/b/h;->abc_menu_shift_shortcut_label:I
    ...
    sget v7, Lg/b/h;->abc_menu_sym_shortcut_label:I
    ...
    sget v6, Lg/b/h;->abc_menu_function_shortcut_label:I

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v6

    invoke-static {v5, v2, v1, v6}, Lg/b/p/i/i;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    :cond_6
    sget v1, Lg/b/h;->abc_menu_space_shortcut_label:I

    goto :goto_4

    :cond_7
    sget v1, Lg/b/h;->abc_menu_enter_shortcut_label:I

    goto :goto_4

    :cond_8
    sget v1, Lg/b/h;->abc_menu_delete_shortcut_label:I
    ...
    .line 12
    iget-object p1, p1, Lg/b/p/i/i;->q:Ljava/lang/CharSequence;
...
.method public final c()V
    ...
    sget v1, Lg/b/g;->abc_list_menu_item_radio:I
...
.method public getItemData()Lg/b/p/i/i;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->e:Lg/b/p/i/i;
...
.method public onFinishInflate()V
    ...
    :cond_1
    sget v0, Lg/b/f;->group_divider:I
...
.method public setCheckable(Z)V
    ...
    invoke-virtual {v0}, Lg/b/p/i/i;->e()Z
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->e:Lg/b/p/i/i;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1
    iget-object v0, v0, Lg/b/p/i/i;->n:Lg/b/p/i/g;

    .line 2
    iget-boolean v0, v0, Lg/b/p/i/g;->s:Z
    ...
    sget v3, Lg/b/g;->abc_list_menu_item_icon:I

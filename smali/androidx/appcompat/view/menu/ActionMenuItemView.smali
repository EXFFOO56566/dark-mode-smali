...
# instance fields
.field public i:Lg/b/p/i/i;

.field public j:Ljava/lang/CharSequence;

.field public k:Landroid/graphics/drawable/Drawable;

.field public l:Lg/b/p/i/g$b;

.field public m:Lg/b/q/f0;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lg/b/q/x;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Lg/b/j;->ActionMenuItemView:[I
    ...
    sget p2, Lg/b/j;->ActionMenuItemView_android_minWidth:I
...
.method public a(Lg/b/p/i/i;I)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Lg/b/p/i/i;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->m:Lg/b/q/f0;
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->m:Lg/b/q/f0;
...
.method public c()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Lg/b/p/i/i;

    invoke-virtual {v0}, Lg/b/p/i/i;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final f()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Lg/b/p/i/i;

    .line 1
    iget v2, v2, Lg/b/p/i/i;->y:I
    ...
    .line 3
    iget-object v2, v2, Lg/b/p/i/i;->q:Ljava/lang/CharSequence;
    ...
    .line 5
    iget-object v2, v2, Lg/b/p/i/i;->e:Ljava/lang/CharSequence;
    ...
    .line 7
    iget-object v2, v2, Lg/b/p/i/i;->r:Ljava/lang/CharSequence;
    ...
    .line 9
    iget-object v1, v0, Lg/b/p/i/i;->e:Ljava/lang/CharSequence;

    .line 10
    :goto_4
    invoke-static {p0, v1}, Landroid/support/v4/media/session/MediaSessionCompat;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    goto :goto_5

    :cond_7
    invoke-static {p0, v2}, Landroid/support/v4/media/session/MediaSessionCompat;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Lg/b/p/i/g$b;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Lg/b/p/i/i;

    invoke-interface {p1, v0}, Lg/b/p/i/g$b;->a(Lg/b/p/i/i;)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lg/b/p/i/i;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->m:Lg/b/q/f0;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, Lg/b/q/f0;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setExpandedFormat(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->i:Lg/b/p/i/i;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1, v0, v0, v0}, Lg/b/q/x;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public setItemInvoker(Lg/b/p/i/g$b;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->l:Lg/b/p/i/g$b;

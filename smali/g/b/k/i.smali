...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p0, p1, p2}, Lg/b/k/s;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p1, p2, p0, v0}, Landroidx/appcompat/app/AlertController;-><init>(Landroid/content/Context;Lg/b/k/s;Landroid/view/Window;)V

    iput-object p1, p0, Lg/b/k/i;->g:Landroidx/appcompat/app/AlertController;
...
.method public static a(Landroid/content/Context;I)I
    ...
    sget v0, Lg/b/a;->alertDialogTheme:I
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-super/range {p0 .. p1}, Lg/b/k/s;->onCreate(Landroid/os/Bundle;)V

    move-object/from16 v0, p0

    iget-object v1, v0, Lg/b/k/i;->g:Landroidx/appcompat/app/AlertController;
    ...
    .line 2
    :goto_1
    iget-object v4, v1, Landroidx/appcompat/app/AlertController;->b:Lg/b/k/s;

    invoke-virtual {v4, v2}, Lg/b/k/s;->setContentView(I)V

    .line 3
    iget-object v2, v1, Landroidx/appcompat/app/AlertController;->c:Landroid/view/Window;

    sget v4, Lg/b/f;->parentPanel:I

    invoke-virtual {v2, v4}, Landroid/view/Window;->findViewById(I)Landroid/view/View;

    move-result-object v2

    sget v4, Lg/b/f;->topPanel:I

    invoke-virtual {v2, v4}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v4

    sget v5, Lg/b/f;->contentPanel:I

    invoke-virtual {v2, v5}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v5

    sget v6, Lg/b/f;->buttonPanel:I

    invoke-virtual {v2, v6}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v6

    sget v7, Lg/b/f;->customPanel:I
    ...
    check-cast v7, Lg/b/q/g0$a;

    const/4 v10, 0x0

    iput v10, v7, Lg/b/q/g0$a;->a:F
    ...
    sget v14, Lg/b/a;->alertDialogCenterButtons:I
    ...
    sget v10, Lg/b/f;->title_template:I
    ...
    sget v10, Lg/b/f;->textSpacerNoButtons:I
    ...
    :cond_23
    :goto_10
    sget v10, Lg/b/f;->titleDividerNoCustom:I
    ...
    :cond_24
    sget v4, Lg/b/f;->textSpacerNoTitle:I
    ...
    sget v9, Lg/b/f;->scrollIndicatorUp:I
    ...
    sget v10, Lg/b/f;->scrollIndicatorDown:I
    ...
    invoke-static {v2, v4, v6}, Lg/h/r/p;->a(Landroid/view/View;II)V
    ...
    new-instance v4, Lg/b/k/b;

    invoke-direct {v4, v1, v7, v8}, Lg/b/k/b;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    new-instance v4, Lg/b/k/c;

    invoke-direct {v4, v1, v7, v8}, Lg/b/k/c;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V
    ...
    new-instance v4, Lg/b/k/d;

    invoke-direct {v4, v1, v7, v8}, Lg/b/k/d;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V

    invoke-virtual {v2, v4}, Landroid/widget/ListView;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V

    iget-object v2, v1, Landroidx/appcompat/app/AlertController;->g:Landroid/widget/ListView;

    new-instance v4, Lg/b/k/e;

    invoke-direct {v4, v1, v7, v8}, Lg/b/k/e;-><init>(Landroidx/appcompat/app/AlertController;Landroid/view/View;Landroid/view/View;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, Lg/b/k/i;->g:Landroidx/appcompat/app/AlertController;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-super {p0, p1}, Lg/b/k/s;->setTitle(Ljava/lang/CharSequence;)V
